...
# Libraries to be used in cluster - sapelo2
...
# Locate the installed libraries while running the script in cluster - sapelo2
...
## **Inspecting the training and testing data files**
...
## Load weather data and combine with training data
```{r}
#| message: false
#| warning: false
...
## Clean test and combine data - submission + meta + soil + weather
```{r}
#| message: false
#| warning: false
...
# Recipe using yield_mg_ha as the outcome for both XGBoost and GLMNET models
...
# Prep the recipe to estimate required statistics
...
## **Cross-validation setup -** Resampling
